<template>
	<div class="theme-container">
		<div class="content">
			<h1 class="title"><i class="el-icon-loading"></i> 404</h1>
			<blockquote class="msg">{{ current404Msg }}</blockquote>
			<router-link to="/">
				<div class="home-link">👉 Country road, take me home{{ selectedSuspensionPoint }} 👈</div>
			</router-link>
		</div>
	</div>
</template>
...
<script>
const _404MsgPool = [`此地空无一物～`, `我是谁？我从哪里来？要到哪里去？`, `走丢啦～`, `链接崩了？`];
